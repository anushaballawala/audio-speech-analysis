...
def main():
    ...
    f3_csv_output_directory = '/userdata/msharma/sub-PR05-stage-2_audio-audiotype_preproc_wiener_filtering_metadata_and_plots/sub-PR05_stage-2_audio-audiotype_preproc_wiener_filtering_f3_metadata'
    f3_plot_output_directory = '/userdata/msharma/sub-PR05-stage-2_audio-audiotype_preproc_wiener_filtering_metadata_and_plots/sub-PR05_stage-2_audio-audiotype_preproc_wiener_filtering_f3_plots'
    ...
    for num in range(579, 1067):
        ...
        plot_path = os.path.join(
            ...
            'sub-PR05_stage-2_audio-audiotype_preproc_wiener_' + audio_name_without_wav + '_f3.png'
        )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(f3_plot_output_directory,
                                 'sub-PR05_stage-2_wiener_f3_rel_energy_mean_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(f3_plot_output_directory,
                                 'sub-PR05_stage-2_wiener_f3_rel_energy_std_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(f3_plot_output_directory,
                                 'sub-PR05_stage-2_wiener_f3_rel_energy_iqr_summary.png'),
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(f3_plot_output_directory,
                                 'sub-PR05_stage-2_wiener_f3_rel_energy_mean_sd_errorbar.png'),
        bar_label="Mean ± 1 SD",
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(f3_plot_output_directory,
                                 'sub-PR05_stage-2_wiener_f3_rel_energy_median_iqr_errorbar.png'),
