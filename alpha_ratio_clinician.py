...
def main():
    ...
    alpha_ratio_csv_output_directory = '/userdata/msharma/sub-PR05-clinician_scales_audio-audiotype_preproc_spectral_gating_100_percent_metadata_and_plots/sub-PR05_clinician_scales_audio-audiotype_preproc_spectral_gating_100_percent_alpha_ratio_metadata'
    alpha_ratio_plot_output_directory = '/userdata/msharma/sub-PR05-clinician_scales_audio-audiotype_preproc_spectral_gating_100_percent_metadata_and_plots/sub-PR05_clinician_scales_audio-audiotype_preproc_spectral_gating_100_percent_alpha_ratio_plots'
    ...
    for sound_path in sorted(glob.glob(os.path.join(patient_preproc_data_directory, '*.wav'))):
        ...
        plot_path = os.path.join(
            ...
            'sub-PR05_clinician_scales_audio-audiotype_preproc_' + audio_name_without_wav + '_alpha_ratio.png'
        )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_clinician_scales_alpha_ratio_mean_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_clinician_scales_alpha_ratio_std_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_clinician_scales_alpha_ratio_iqr_summary.png'),
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_clinician_scales_alpha_ratio_mean_sd_errorbar.png'),
        bar_label="Mean ± 1 SD",
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_clinician_scales_alpha_ratio_median_iqr_errorbar.png'),
