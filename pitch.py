...
def main():
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(pitch_plot_output_directory,
                                 'sub-PR05_stage-2_pitch_mean_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(pitch_plot_output_directory,
                                 'sub-PR05_stage-2_f0_lstsq_slope_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(pitch_plot_output_directory,
                                 'sub-PR05_stage-2_f0_lstsq_intercept_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(pitch_plot_output_directory,
                                 'sub-PR05_stage-2_pitch_std_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(pitch_plot_output_directory,
                                 'sub-PR05_stage-2_pitch_iqr_summary.png'),
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(pitch_plot_output_directory,
                                 'sub-PR05_stage-2_pitch_mean_sd_errorbar.png'),
        bar_label="Mean ± 1 SD",
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(pitch_plot_output_directory,
                                 'sub-PR05_stage-2_pitch_median_iqr_errorbar.png'),
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(pitch_plot_output_directory,
                                 'sub-PR05_stage-2_f0_slope_residual_errorbar.png'),
