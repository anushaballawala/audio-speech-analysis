...
def main():
    ...
    patient_raw_data_directory = '/data_store2/resection/neuropsych_video/presidio/Stage2/PR05/home/sub-PR05_stage-2_audio-athome_signal-preproc_wiener_filtering/'
    plot_output_directory = '/userdata/msharma/sub-PR05-stage-2_audio-audiotype_preproc_wiener_filtering_metadata_and_plots/sub-PR05_stage-2_audio-audiotype_raw_audio_plots'
    
    for num in range(579, 1067):
        # audio_name = str(num) + '_audio.wav'
        audio_name = 'sub-PR05_stage-2_audio-athome_signal-preproc_wiener_' + str(num) + '.wav'
