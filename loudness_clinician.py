...
def main():
    ...
    loudness_csv_output_directory = '/userdata/msharma/sub-PR05-clinician_scales_audio-audiotype_preproc_spectral_gating_100_percent_metadata_and_plots/sub-PR05_clinician_scales_audio-audiotype_preproc_spectral_gating_100_percent_loudness_metadata'
    loudness_plot_output_directory = '/userdata/msharma/sub-PR05-clinician_scales_audio-audiotype_preproc_spectral_gating_100_percent_metadata_and_plots/sub-PR05_clinician_scales_audio-audiotype_preproc_spectral_gating_100_percent_loudness_plots'
    ...
    for sound_path in sorted(glob.glob(os.path.join(patient_preproc_data_directory, '*.wav'))):
        ...
        plot_path = os.path.join(
            ...
            'sub-PR05_clinician_scales_audio-audiotype_preproc_' + audio_name_without_wav + '_loudness.png'
        )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(loudness_plot_output_directory,
                                 'sub-PR05_clinician_scales_loudness_mean_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(loudness_plot_output_directory,
                                 'sub-PR05_clinician_scales_loudness_std_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(loudness_plot_output_directory,
                                 'sub-PR05_clinician_scales_loudness_iqr_summary.png'),
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(loudness_plot_output_directory,
                                 'sub-PR05_clinician_scales_loudness_mean_sd_errorbar.png'),
        bar_label="Mean ± 1 SD",
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(loudness_plot_output_directory,
                                 'sub-PR05_clinician_scales_loudness_median_iqr_errorbar.png'),
