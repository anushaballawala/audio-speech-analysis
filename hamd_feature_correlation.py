...
XLSX = BASE / "audio-speech-analysis" / "PR05 List of Video Filenames.xlsx"
SHEET = "Stage 2 AudioScore Match"
OUT_DIR = BASE / "audio-speech-analysis" / "hamd_correlation_output"

SCORE_COLS = ["hamd_total", "vas_anxiety", "vas_depression", "madrs_total", "madrs_score"]

FEATURE_DIRS = {
    "pitch": (
        BASE / "sub-PR05_stage-2_audio-audiotype_preproc_pitch_metadata",
        "_pitches.csv",
        ["pitch_mean", "pitch_std", "pitch_median", "pitch_iqr"],
    ),
    "loudness": (
        BASE / "sub-PR05_stage-2_audio-audiotype_preproc_loudness_metadata",
        "_loudness_in_db.csv",
        ["active_intensity_vals_mean", "intensity_std", "intensity_median", "intensity_iqr"],
    ),
    "f3": (
        BASE / "sub-PR05_stage-2_audio-audiotype_preproc_f3_metadata",
        "_relative_energy_formant.csv",
        ["mean_rel_energy_f_i", "rel_energy_std", "rel_energy_median", "rel_energy_iqr"],
    ),
    "alpha_ratio": (
        BASE / "sub-PR05_stage-2_audio-audiotype_preproc_alpha_ratio_metadata",
        "_alpha_ratio.csv",
