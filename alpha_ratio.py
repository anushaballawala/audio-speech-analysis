...
def main():
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_stage-2_alpha_ratio_mean_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_stage-2_alpha_ratio_std_summary.png'),
    )
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_stage-2_alpha_ratio_iqr_summary.png'),
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_stage-2_alpha_ratio_mean_sd_errorbar.png'),
        bar_label="Mean ± 1 SD",
    )
    ...
    save_summary_errorbar_plot(
        ...
        output_path=os.path.join(alpha_ratio_plot_output_directory,
                                 'sub-PR05_stage-2_alpha_ratio_median_iqr_errorbar.png'),
