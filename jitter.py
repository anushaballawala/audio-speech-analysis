...
def main():
    ...
    jitter_csv_output_directory = '/userdata/msharma/sub-PR05-stage-2_audio-audiotype_preproc_wiener_filtering_metadata_and_plots/sub-PR05_stage-2_audio-audiotype_preproc_wiener_filtering_jitter_metadata'
    jitter_plot_output_directory = '/userdata/msharma/sub-PR05-stage-2_audio-audiotype_preproc_wiener_filtering_metadata_and_plots/sub-PR05_stage-2_audio-audiotype_preproc_wiener_filtering_jitter_plots'
    ...
    save_summary_point_plot(
        ...
        output_path=os.path.join(jitter_plot_output_directory,
                                 'sub-PR05_stage-2_wiener_jitter_summary.png'),
    )
